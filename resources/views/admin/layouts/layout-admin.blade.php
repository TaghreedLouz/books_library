                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                        ...
                        <ul class="menu-nav">
                            <li class="menu-item" aria-haspopup="true">
                                <a href="/admin/allbooks" class="menu-link">
                                    <i class="menu-icon flaticon-home"></i>
                                    <span class="menu-text">All Books</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="admin/customersBooks" class="menu-link">
                                    <i class="menu-icon flaticon-book"></i>
                                    <span class="menu-text">customers and books purchased</span>
                                </a>
                            </li>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                    ...
                                    <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2">
                                        ...
                                        <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-1">{{Auth::user()->name}}</span>
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            ...
                            <div class="alert alert-custom alert-notice alert-light-{{session('alter')}} fade show mb-5" role="alert">
